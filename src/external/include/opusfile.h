...
#define OP_GNUC_PREREQ(_maj, _min) ((__GNUC__ << 16) + __GNUC_MINOR__ >= ((_maj) << 16) + (_min))
#else
...
int opus_tags_add(OpusTags* _tags, const char* _tag, const char* _value) OP_ARG_NONNULL(1) OP_ARG_NONNULL(2)
    OP_ARG_NONNULL(3);
...
/**Parse a single METADATA_BLOCK_PICTURE tag.
   ...
   \retval #OP_EFAULT     There was not enough memory to store the picture tag
                           contents.*/
OP_WARN_UNUSED_RESULT int opus_picture_tag_parse(OpusPictureTag* _pic, const char* _tag) OP_ARG_NONNULL(1)
    OP_ARG_NONNULL(2);
...
/**Opens a stream with <code>fopen()</code> and fills in a set of callbacks
   ...
   \return A stream handle to use with the callbacks, or <code>NULL</code> on
            error.*/
OP_WARN_UNUSED_RESULT void* op_fopen(OpusFileCallbacks* _cb, const char* _path, const char* _mode) OP_ARG_NONNULL(1)
...
/**Opens a stream with <code>fdopen()</code> and fills in a set of callbacks
   ...
   \return A stream handle to use with the callbacks, or <code>NULL</code> on
            error.*/
OP_WARN_UNUSED_RESULT void* op_fdopen(OpusFileCallbacks* _cb, int _fd, const char* _mode) OP_ARG_NONNULL(1)
    OP_ARG_NONNULL(3);
...
/**Opens a stream with <code>freopen()</code> and fills in a set of callbacks
   ...
   \return A stream handle to use with the callbacks, or <code>NULL</code> on
            error.*/
OP_WARN_UNUSED_RESULT void* op_freopen(OpusFileCallbacks* _cb, const char* _path, const char* _mode, void* _stream)
    OP_ARG_NONNULL(1) OP_ARG_NONNULL(2) OP_ARG_NONNULL(3) OP_ARG_NONNULL(4);
...
/**Creates a stream that reads from the given block of memory.
   ...
   \return A stream handle to use with the callbacks, or <code>NULL</code> on
            error.*/
OP_WARN_UNUSED_RESULT void* op_mem_stream_create(OpusFileCallbacks* _cb, const unsigned char* _data, size_t _size)
    OP_ARG_NONNULL(1);
...
/**Creates a stream that reads from the given URL.
   ...
   \return A stream handle to use with the callbacks, or <code>NULL</code> on
            error.*/
OP_WARN_UNUSED_RESULT void* op_url_stream_vcreate(OpusFileCallbacks* _cb, const char* _url, va_list _ap)
...
/**Creates a stream that reads from the given URL.
   ...
   \return A stream handle to use with the callbacks, or <code>NULL</code> on
            error.*/
OP_WARN_UNUSED_RESULT void* op_url_stream_create(OpusFileCallbacks* _cb, const char* _url, ...) OP_ARG_NONNULL(1)
    OP_ARG_NONNULL(2);
...
OP_WARN_UNUSED_RESULT OggOpusFile* op_open_callbacks(void* _stream, const OpusFileCallbacks* _cb,
...
/**Partially open a stream using the given set of callbacks to access it.
   ...
   \return A partially opened \c OggOpusFile, or <code>NULL</code> on error.
           ...
           The calling application is responsible for closing the stream if
            this call returns an error.*/
OP_WARN_UNUSED_RESULT OggOpusFile* op_test_callbacks(void* _stream, const OpusFileCallbacks* _cb,
                                                     const unsigned char* _initial_data, size_t _initial_bytes,
                                                     int* _error) OP_ARG_NONNULL(2);
...
/**Called to decode an Opus packet.
   ...
   \retval #OP_DEC_USE_DEFAULT No decoding was done.
                               <tt>libopusfile</tt> should do the decoding
                                by itself instead.*/
typedef int (*op_decode_cb_func)(void* _ctx, OpusMSDecoder* _decoder, void* _pcm, const ogg_packet* _op, int _nsamples,
                                 int _nchannels, int _format, int _li);
